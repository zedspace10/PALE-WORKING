...
const MW_FACTS = [
  ...
  "Our Sun takes about 230 million years to circle the galactic centre once.",
  "The Milky Way and Andromeda are closing on each other, though whether they collide is no longer certain.",
];
